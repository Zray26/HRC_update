...
#   left_arm_half_joint (0), left_elbow_joint (1), left_gripper_finger1_joint (2), left_shoulder_lift_joint (3),
#   left_shoulder_pan_joint (4), left_wrist_3_joint (5), left_wrist_spherical_1_joint (6), left_wrist_spherical_2_joint (7),
#   linear_joint (8), pan_joint (9), right_arm_half_joint (10), right_elbow_joint (11), right_gripper_finger1_joint (12),
#   right_shoulder_lift_joint (13), right_shoulder_pan_joint (14), right_wrist_3_joint (15), right_wrist_spherical_1_joint (16),
#   right_wrist_spherical_2_joint (17), tilt_joint (18)
    # tmp_r:                                                        tmp_l: 
    # right_shoulder_pan_joint 14                                   left_shoulder_pan_joint 4
    # right_shoulder_lift_joint 13                                  left_shoulder_lift_joint 3
    # right_arm_half_joint 10                                       left_arm_half_joint 0
    # right_elbow_joint 11                                          left_elbow_joint 1
    # right_wrist_sepherical_1_joint 16                             left_wrist_sepherical_1_joint 6
    # right_wrist_sepherical_2_joint 17                             left_wrist_sepherical_2_joint 7
    # right_writs_3_joint 15                                        left_writs_3_joint 5
        
        # tmp_r = rospy.wait_for_message("/movo/right_arm_controller/states", JointState)
        # tmp_l = rospy.wait_for_message("/movo/left_arm_controller/states", JointState)
        # print("Massage received in L0_dual_joint_rot_relate")
        # current_angles_r = tmp_r.position  # tuple (p1,p2,p3,p4,p5,p6,p7) in radius -pi -> pi
        # current_angles_l = tmp_l.position
        
        # current_angles_r = [tmp_all_pos[14],tmp_all_pos[13],tmp_all_pos[10],tmp_all_pos[11],tmp_all_pos[16],tmp_all_pos[17],tmp_all_pos[15]]
        # current_angles_l = [tmp_all_pos[4],tmp_all_pos[3],tmp_all_pos[0],tmp_all_pos[1],tmp_all_pos[6],tmp_all_pos[7],tmp_all_pos[5]]
        # current_angles_r = tuple(current_angles_r)
        # current_angles_l = tuple(current_angles_l)
        # print("current_angles_r is:")
        # print(current_angles_r)
        # print(type(current_angles_r))
    ...
    def send_sub_goal(self,goal):
        self.sub_done=False
                # *************************************
        print("hi, in send_sub_goal,before self.L0_dual_joint_rot_relate")
        # *************************************
        self.L0_dual_joint_rot_relate(l_rot=goal.jp_left_relate,
                                      r_rot=goal.jp_right_relate,
                                      total_time=goal.duration)
        # *************************************
        print("hi, in send_sub_goal,after self.L0_dual_joint_rot_relate")
        # *************************************
        pass
    ...
    def execute_cb(self,goal):
        ...
        rospy.loginfo("goal get"+str(goal))
        # *************************************
        print("hi, in execute_cb,after rospy.loginfo")
        # *************************************
        self.goal_start_time=time.time()
        if(not(self._goal_check(goal))):
            rospy.loginfo("Fail, the goal was rejected")
        ...
        self._pub_feedback()
        # *************************************
        print("hi, in execute_cb,after self._pub_feedback()")
        # *************************************
        if(success==True):
            # *************************************
            print("hi, in execute_cb, after if(success==True)")
            # *************************************
            self.send_sub_goal(goal)

            while(not rospy.is_shutdown()):
                # *************************************
                print("hi, in execute_cb, after while(not rospy.is_shutdown())")
            # *************************************
                r=rospy.Rate(50)
                r.sleep()
                if self._as.is_preempt_requested():
...
class L0_dual_task_move_safe_relate_srv():
    ...
    def L0_dual_tcp_move_relate(self,lmove,rmove,total_time,point_num=10):
        ...
        # tmp_l = rospy.wait_for_message("/movo/left_arm_controller/states", JointState)
        # print("Massage received in L0_dual_joint_rot_relate")
        r_j = list(self._c.movegroup_rarm_group.get_current_joint_values())
        l_j = list(self._c.movegroup_larm_group.get_current_joint_values())
        print(r_j)
        self.jointcontrol_client_left.add_point(r_j,0)
        self.jointcontrol_client_right.add_point(l_j,0)
