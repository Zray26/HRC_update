    ...
    def L0_dual_joint_rot_relate(self, l_rot, r_rot, total_time):
        ...
        if (self.count<18):
            ...
            while (du< total_time):
                ...
                self.jointcontrol_client_left.add_point(l_jp_position, du + self.total_dancing_time)
                self.jointcontrol_client_right.add_point(r_jp_position, du + self.total_dancing_time)
            print("r_jp after adding")
            print(r_jp_position)
            self.total_dancing_time = self.total_dancing_time + total_time
        ...
        if (self.count == 18):
            print("count is 15, begin to move")
            # print(l_jp_position)
            self.jointcontrol_client_right.start()
            self.jointcontrol_client_left.start()
            self.jointcontrol_client_right.wait(self.total_dancing_time + 10)
            self.jointcontrol_client_left.wait(self.total_dancing_time + 10)
